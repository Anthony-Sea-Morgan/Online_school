    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('technologies', multiselectfield.db.fields.MultiSelectField(choices=[('Python', 'Python'), ('C++', 'C++'), ('Java', 'Java'), ('C#', 'C#'), ('Pascal', 'Pascal')], default='Python', max_length=25, validators=[django.core.validators.MaxValueValidator(5)], verbose_name='Применяемы языки')),
